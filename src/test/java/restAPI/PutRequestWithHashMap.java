...
public class PutRequestWithHashMap {
	...
	@Test
	public void updateRequestWithHashMap() {
		
		HashMap<String,Object> updateReqBody = new HashMap<String,Object>();
		updateReqBody.put("name","Sara");
		updateReqBody.put("salary","20100");
